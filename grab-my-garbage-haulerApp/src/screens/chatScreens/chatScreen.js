...
import { renderMessage, renderBubble, renderComposer, renderInputToolbar, renderSend, scrollToBottomComponent, renderTick, renderMessageText } from '../../helpers/chatScreenHelper'
...
const Chatscreen = ({route, navigation}) => {
    ...
    const onSend = useCallback((messages = [], imageMessage) => {
        if(imageMessage) {
